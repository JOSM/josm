...
public class IconRotationTest {
    ...
    @Test
    public void rotation_way_no_parent() {
        Node n = (Node) OsmUtils.createPrimitive("n");
        ds.addPrimitive(n);
     ...
     */
    @Test
    public void rotation_way_multiple() {
