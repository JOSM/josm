...
public class PluginHandlerJOSMTooOldTest {
    ...
    public void setUp() {
        ...
        this.referenceQuxJarNew = new File(TestUtils.getTestDataRoot(), "__files/" + referencePathQuxJarNew);
    ...
    private static final String referencePathQuxJarNew = "plugin/qux_plugin.v346.jar";
    ...
    private File referenceQuxJarNew;
    ...
    public void testUpdatePluginsMultiVersionInsufficient() throws Exception {
        TestUtils.assumeWorkingJMockit();

        final String quxNewServePath = "/qux/new.jar";
        final PluginServer pluginServer = new PluginServer(
